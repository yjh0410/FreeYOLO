...
model_urls = {
    "cspdarknet_tiny": "https://github.com/yjh0410/PyTorch_YOLO-Family/releases/download/yolo-weight/cspdarknet_tiny.pth",
}


__all__ = ['build_cspdarknet53']
...
# Build CSPDarkNet-Tiny
def build_cspdarknet_tiny(pretrained=False):
    # build backbone
    ...
    if pretrained:
        ...
        url = model_urls['cspdarknet_tiny']
...
if __name__ == '__main__':
    import time
    model, feats = build_cspdarknet_tiny(pretrained=True)
